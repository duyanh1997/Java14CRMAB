        ...
        <div class="navbar navbar-secondary navbar-light navbar-expand-sm p-0">
            ...
            <div class="navbar-collapse collapse" id="navbarsExample03">
                <ul class="nav navbar-nav flex">
                    <li class="nav-item">
                        <a class="nav-link active" href="/java14crmgv/home">
                            Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/java14crmgv/manager-project">
                                Manage Project
                            </a>
                            <a class="dropdown-item" href="/java14crmgv/create-project">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/java14crmgv/user-list">
                                User List
                            </a>
                            <a class="dropdown-item" href="/java14crmgv/create-user">
                                Create User
                            </a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/java14crmgv/task">Task</a>
                    </li>
                    <li class="nav-item dropdown">
